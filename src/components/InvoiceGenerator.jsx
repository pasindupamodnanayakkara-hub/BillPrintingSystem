...
const generateInvoiceNumber = () => `INV-${Math.floor(Math.random() * 10000000)}`;
          ...
          <div className="p-6 space-y-8 pb-10">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div className="relative">
                  <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Client Name *</label>
                  <input type="text" placeholder="e.g. John Doe" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.clientName} onChange={(e) => handleInputChange('clientName', e.target.value)} />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="relative">
                    <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Email</label>
                    <input type="text" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.clientEmail} onChange={(e) => handleInputChange('clientEmail', e.target.value)} />
                  </div>
                  <div className="relative">
                    <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Phone</label>
                    <input type="text" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.clientPhone} onChange={(e) => handleInputChange('clientPhone', e.target.value)} />
                  </div>
                </div>
                <div className="relative">
                  <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Address</label>
                  <input type="text" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.clientAddress} onChange={(e) => handleInputChange('clientAddress', e.target.value)} />
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="relative">
                    <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Invoice #</label>
                    <input type="text" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.invoiceNumber} onChange={(e) => handleInputChange('invoiceNumber', e.target.value)} />
                  </div>
                  <div className="relative">
                    <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Date</label>
                    <input type="text" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.invoiceDate} onChange={(e) => handleInputChange('invoiceDate', e.target.value)} />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="relative">
                    <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Due Date</label>
                    <input type="text" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.dueDate} onChange={(e) => handleInputChange('dueDate', e.target.value)} />
                  </div>
                  <div className="relative">
                    <label className="text-[10px] absolute -top-2 left-3 bg-white px-1 font-bold text-gray-400 z-10">Tax (%)</label>
                    <input type="number" className="w-full border border-gray-200 rounded-xl p-3 text-sm focus:border-accent-gold outline-none" value={invoiceData.taxRate} onChange={(e) => handleInputChange('taxRate', e.target.value)} />
                  </div>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-3">
                {invoiceData.items.map((item) => (
                  <div key={item.id} className="bg-gray-50/50 p-3 rounded-2xl border border-gray-100 space-y-2 relative group">
                    <input type="text" placeholder="Service or Product Description" className="w-full bg-transparent p-1 text-sm font-semibold border-b border-gray-200 focus:border-accent-gold outline-none" value={item.description} onChange={(e) => handleItemChange(item.id, 'description', e.target.value)} />
