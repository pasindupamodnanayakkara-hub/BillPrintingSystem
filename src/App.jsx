...
import { FileText, Settings as SettingsIcon, History, Cloud } from 'lucide-react';
...
function App() {
  ...
  const [showSetup, setShowSetup] = useState(() => localStorage.getItem('BILL_STUDIO_SETUP_COMPLETE') !== 'true');
        ...
        <nav className="bg-white border-b border-gray-200 px-8 py-3 flex justify-between items-center shadow-sm z-20 shrink-0 print:hidden">
          ...
          <div className="flex bg-gray-100 p-1 rounded-2xl gap-1">
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeTab === 'backup' ? 'bg-white text-black shadow-md' : 'text-gray-500 hover:bg-gray-200'}`}
            >
              <Cloud size={16} />
              Cloud Backup
            </button>
